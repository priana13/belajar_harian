        ...
        return $form
            ->schema([     
                ...
                Forms\Components\Select::make('materi_id')->relationship('materi', 'nama_materi')->searchable()->preload()
                    ->required(), 
                Forms\Components\Select::make('gelombang_id')->relationship('gelombang', 'judul')->searchable()->preload()
                    ->required(), 
    ...
    public static function table(Table $table): Table
    {
        return $table
            ->columns([  
                ...
                Tables\Columns\TextColumn::make('gelombang.judul'),
            ...
            ->filters([    
                SelectFilter::make('gelombang_id')->relationship('gelombang', 'judul'),
                SelectFilter::make('materi_id')->relationship('materi', 'nama_materi'),
            ])
            ->actions([
                ActionGroup::make([
