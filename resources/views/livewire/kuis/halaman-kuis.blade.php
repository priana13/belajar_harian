...
@endpush
    ...
    <div class="p-5">
        ...
        <div class="flex sticky bottom-0 justify-between items-center pt-12 pb-24 ">
            <button class="p-3 w-52  rounded-full bg-accent font-bold text-center ">
    ...
    <section class="fixed flex justify-between items-center inset-x-0 -bottom-[1px] z-10 bg-primary-700 shadow-top  py-5 px-9 max-w-lg mx-auto text-gray-400">
        <div class="flex items-center gap-1.5">
            <i class="fa-solid fa-stopwatch text-white"></i>
            <p id="countdown" wire:ignore class="text-white"></p>
        </div>
        <button class="bg-white p-1.5 w-32  rounded-full  text-primary font-semibold open-modal" data-modal-id="myModal1">
            Kirim Jawaban
        </button>
    </section> 
    <script>
