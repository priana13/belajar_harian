 ...
 i.fa-play-circle, i.fa-pause-circle, i.fa-step-forward, i.fa-step-backward {
  ...
  <div class="p-3">       
      ...
      @else
        ...
        <p class="my-2">
          Kode Angkatan: <span class="font-bold">{{ $angkatan->materi->nama_materi }}</span>  <br>
          Mulai Pembelajaran : <span class="font-bold">{{ date('d M Y', strtotime( $angkatan->tanggal_mulai )) }}</span> 
        </p>
      ...
      {{-- @foreach ($materi as $row) --}}
        ...
        <div class="p-2 border rounded-lg my-3">
            ...
            @if($materi)
              ...
              {{-- {{ dd($materi->materi_detail->materi_id ) }} --}}
