  ...
  <div class="p-3">       
      ...
      @if(auth()->user()->angkatan_user()->aktif()->count() == 0)
       ...
       <p class="prose-sm mt-5 font-semibold mb-2">Materi Tersedia:</p>
        ...
        ?>
         ...
         @if( $row->angkatan_user->count() < $row->kuota 
         && $cek_mulai_pendaftaran 
        //  && $cek_akhir_pendaftaran
         )
      ...
      <div class="hidden">
          ...
          <p class="my-2">
            ...
            {{-- Ujian Akhir : <span class="font-bold">{{ date('d M Y', strtotime( $angkatan->tanggal_ujian )) }}</span>  <br> --}}
            Kelas: <span class="font-bold">{{ $angkatan->kode_angkatan }}</span> 
          </p>
