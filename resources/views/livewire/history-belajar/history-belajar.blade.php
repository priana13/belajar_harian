    ...
    @endpush
        ...
        <div class="p-5">
            @foreach($ujian_akhir as $row)
                ...
                <div class="grid grid-cols-[40%_30%_25%] gap-3 items-center mt-1 p-2">
                    <p class="font-semibold">{{ $no }}. {{$row->materi->nama_materi}}</p>
                    <p class="text-center">
                        <a href="{{ route('daftar_nilai' , $row->kode_ujian) }}" class="hover:text-blue-400 flex">
                    ...
                    <p class="flex">                        
                        <a href="{{ route('sertifikat' , $row->kode_ujian) }}" target="_blank" class="flex items-center">
