    ...
    @endpush
        ...
        <div class="p-5 glass-effect">
            @foreach($ujian_akhir as $row) 
                ...
                <div class="grid grid-cols-[50%_25%_25%] gap-3 items-center my-3 p-2 border-b-2 track-item modern-card">
                    <p class="font-semibold">{{ $no }}. {{$row->materi->nama_materi}} <br>
                       <span class="ms-4 text-sm text-gray-500">   {{ date('d M Y' , strtotime( $row->created_at )) }}</span> 
                    </p>
                    
                   
                        <p class="text-center">
                            {{-- Pre: {{ $row->predikat }}                       --}}
                            <a href="{{ route('daftar_nilai' , $row->kode_ujian ) }}" class="hover:text-blue-400 flex" target="_blank">
                                <svg class="w-6 me-1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512">addUjianIdToSertifikatUserSeeder<!--!Font Awesome Free 6.5.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.--><path d="M0 64C0 28.7 28.7 0 64 0H224V128c0 17.7 14.3 32 32 32H384v38.6C310.1 219.5 256 287.4 256 368c0 59.1 29.1 111.3 73.7 143.3c-3.2 .5-6.4 .7-9.7 .7H64c-35.3 0-64-28.7-64-64V64zm384 64H256V0L384 128zM288 368a144 144 0 1 1 288 0 144 144 0 1 1 -288 0zm211.3-43.3c-6.2-6.2-16.4-6.2-22.6 0L416 385.4l-28.7-28.7c-6.2-6.2-16.4-6.2-22.6 0s-6.2 16.4 0 22.6l40 40c6.2 6.2 16.4 6.2 22.6 0l72-72c6.2-6.2 6.2-16.4 0-22.6z"/></svg>
                                Daftar Nilai
                            </a>
                        </p>
                    ...
                    @if($row->predikat !== 'Kurang')                    
                        ...
                        @if($row->sertifikat_user)
                            {{-- {{ dd($row->sertifikat_user->code) }} --}}

                        <p class="flex">                        
                            <a href="{{ route('sertifikat' , $row->sertifikat_user->code) }}" target="_blank" class="flex items-center">
