    ...
    <x-FrontTopNav />
        <div class="p-3">
            <div x-data="{ activeTab: 'materi_ajaran' }" class="max-w-lg mx-auto mt-6">
                <div class="flex text-sm shadow rounded-lg">
                    
                   <button
                        x-on:click="activeTab = 'materi_ajaran'"
                        :class="{'bg-white text-primary': activeTab == 'materi_ajaran', 'bg-primary-600 text-white': activeTab !== 'materi_ajaran' }"
                        class="flex-1 py-2 px-4 text-center font-semibold  border-b-2 border-primary-600"
                    >
                        AUDIO
                    </button>
                    ...
                    @if( $mbs_check )
                    <button
                      x-on:click="activeTab = 'materi_video'"
                        :class="{'bg-white text-primary': activeTab == 'materi_video', 'bg-primary-600 text-white': activeTab !== 'materi_video' }"
                        class="flex items-center py-2 px-4 text-center font-semibold  border-b-2 border-primary-600"
                    >
                        VIDEO

                        <svg class="w-4 h-4 fill-[#f5d072] ms-1 -mt-1" viewBox="0 0 576 512" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <button
                        ...
                        :class="{ 'bg-white text-primary': activeTab == 'evaluasi', 'bg-primary-600 text-white': activeTab !== 'evaluasi' }"
                        class="flex-1 py-2 px-4 text-center font-semibold border-b-2 border-primary-600 focus:outline-none"
                    >
                        EVALUASI
                    </button>
                    <button
                        x-on:click="activeTab = 'lainnya'"
                        :class="{ 'bg-white text-primary': activeTab == 'lainnya', 'bg-primary-600 text-white': activeTab !== 'lainnya' }"
                        class="flex-1 py-2 px-4 text-center font-semibold border-b-2 border-primary-600 rounded-r-lg"
                    >
                        LAINNYA
                    </button>
                </div>
        ...
        <x-modal.ModalPopup id="myModal" default="close">
         ...
         <script>
            ...
            function loadTrack(track_index) {
              ...
              tombolSoal = document.getElementById('tombolSoal');
