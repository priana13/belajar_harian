...
<form wire:submit.prevent="submit" enctype="multipart/form-data">
    ...
    <div class="px-3">
        ...
        <div class="grid grid-cols-2 gap-3">
            <div class="py-1">
                ...
                <div class="relative text-gray-400 text-lg font-bold">
                    ...
                    <select type="" name="gender" class="py-3  w-full text-gray-500 rounded-md pl-10 border-gray-300" placeholder="" autocomplete="off">
        ...
        <div class="grid grid-cols-[40%_57%] gap-3">
            <div class="py-1">
