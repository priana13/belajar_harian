...
<div class="p-4 text-center">
    <h1 class="text-2xl font-bold mb-4">Daftar Kelas RJMI</h1>
    <div class="space-y-4">
        ...
        <div class="p-4 bg-white rounded shadow">
            ...
            <form action="{{ route('daftar-kelas-khusus.post') }}" method="POST">
                ...
                <button type="submit" class="mt-4 px-4 py-2 bg-blue-500 text-white rounded hover:bg-blue-600">Ikuti Kelas RJMI</button>
            </form>
