<x-filament::page>
    ...
    <div class="sm:w-1/4 bg-blue-100 card p-4 mb-6 rounded-lg">
        ...
        <select wire:model.live="gelombang" name="" id="" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
            ...
            <option value="group">Berdasarkan Group</option>
        </select>
        ...
        <label for="" class="block mb-2 text-normal font-medium text-gray-900 dark:text-white mt-3">Pilih Group (Opsional)</label>
        <select wire:model.live="group" name="" id="" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
            <option value="">Tidak Memilih Group</option>
            ...
            <table class="table-auto border-collapse border border-slate-400 mt-3">
                <thead>
                    <tr>
                        ...
                        {{-- GROUP --}}
                        <th class="border border-slate-300 px-4 py-2">Group</th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="border border-slate-300 px-4 py-2">{{ $row->group?->nama_group ?? '-' }}</td>
